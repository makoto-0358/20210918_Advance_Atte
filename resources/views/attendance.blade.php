                ...
                <!-- <div> -->
                    ...
                    <table class="ml-8 flex md:justify-center overflow-x-auto whitespace-no-wrap md:w-4/5 md:mx-auto">
                        <tr class="flex flex-no-wrap border-t-2 border-gray-400">
                            <th class="w-24 h-12 flex justify-center items-center md:w-56">名前</th>
                            <th class="w-24 h-12 flex justify-center items-center md:w-56">勤務開始</th>
                            <th class="w-24 h-12 flex justify-center items-center md:w-56">勤務終了</th>
                            <th class="w-24 h-12 flex justify-center items-center md:w-56">休憩時間</th>
                            <th class="w-24 h-12 flex justify-center items-center md:w-56">勤務時間</th>
                        </tr>
